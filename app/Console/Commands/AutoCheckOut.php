...
class AutoCheckOut extends Command
{
    ...
    protected $description = 'Melakukan checkout otomatis untuk user yang memiliki absent_type 1';
    ...
    private function checkoutUser($user)
    {
        ...
        try {
            ...
            if ($response->successful()) {
                ...
                $this->sendTelegramNotification($user, "Check-out otomatis gagal: {$body}");
            }
        } catch (\Exception $e) {
